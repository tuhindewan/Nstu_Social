      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="actives"><a href="profile.html"><strong><?php echo $username; ?></strong></a></li>
            ...
            <div class="profile-info-left">
              ...
              <div class="action-buttons">
                <div class="row">
                  ...
                  <?php  
                  $isFollowing = False;
                  $select_query = "SELECT follower_id FROM followers WHERE user_id='$userId'";
                    $result= $db->select($select_query);
                  if (isset($_POST['follow'])) {
                    if ($userId!=$followerId) {
                      if ($result==false) {
                      $query = "INSERT INTO followers (user_id,follower_id) VALUES ('$userId','$followerId')";
                  ...
                  if (isset($_POST['unfollow'])) {
                    ...
                    if ($userId!=$followerId) {
                      if ($result==true) {
                      $query = "DELETE FROM followers WHERE user_id = '$userId' AND follower_id = '$followerId'";
